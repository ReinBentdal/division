...
abstract class GeneralStyle {
  GeneralStyle({AngleFormat angleFormat = AngleFormat.cycles}) : _angleFormat = angleFormat;
  ...
  GeneralStyle sweepGradient(
    ...
    else endAngle = _angleToRadians(endAngle, _angleFormat);
...
class Parent extends GeneralStyle {
  Parent({Widget child, AngleFormat angleFormat = AngleFormat.cycles, Parent style})
      : _child = child,
...
class Txt extends GeneralStyle {
  Txt(final String text, {AngleFormat angleFormat = AngleFormat.cycles, final Txt style})
      : _text = text,
        super(angleFormat: angleFormat) {
    if (style != null) inject(style);
  }
